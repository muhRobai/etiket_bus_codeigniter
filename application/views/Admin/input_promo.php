  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <!--------------------------
        ...
        -------------------------->
        <form class="form-horizontal" method="post" action="<?php echo base_url();?>Admin/add_promo">
              <div class="box-body">
                <div class="form-group">
                  <label for="kodepromo" class="col-sm-2 control-label">Kode Promo</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="kodepromo" name="kodepromo" value="<?php echo $kode?>" disabled>
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="IDpromo" name="idpromo" value="<?php echo $idpromo ?>" disabled>
                  </div>
                </div>
                <div class="form-group">
                  <label for="waktupromo" class="col-sm-2 control-label">Awal Promo</label>
                ...
                <div class="form-group">
                  <label for="waktupromo" class="col-sm-2 control-label">Akhir Promo</label>
                  <div class="col-sm-10">
