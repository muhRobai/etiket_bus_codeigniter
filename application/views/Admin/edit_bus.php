  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <!--------------------------
        ...
        -------------------------->
        <form class="form-horizontal" method="post" action="<?php echo base_url();?>Admin/update_bus" role="form">
              <div class="box-body">
                <?php foreach ($ebus as $qweq) {?>
                <div class="form-group">
                  <label for="kodebus" class="col-sm-2 control-label">Nomor Bus</label>
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="kodebus" name="nobus" value="<?php echo $qweq ->nomor_bus ?>">
                  </div>
                </div>
                <div class="form-group">
                  <label for="namabus" class="col-sm-2 control-label">Nama Bus</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="namabus" value="<?php echo $qweq ->nama_bus ?>" name="namabus">
                  </div>
                </div>
                <div class="form-group">
                  <label for="tipebus" class="col-sm-2 control-label">Kelas</label>
                  <?php $tipe =  $qweq ->tipe_bus ?>

                <?php if ($tipe == 'Bisnis') {?>
                  <div class="col-sm-10">
                      <select class="form-control select2" style="width: 100%;" name="kelas">
                        <option selected="selected">Bisnis</option>
                        <option>Ekonomi AC</option>
                        <option>Ekonomi</option>
                      </select>
                  </div>
                <?php } elseif ( $tipe == 'Ekonomi AC') {?>
                <div class="col-sm-10">
                      <select class="form-control select2" style="width: 100%;" name="kelas">
                        <option>Bisnis</option>
                        <option selected="selected">Ekonomi AC</option>
                        <option>Ekonomi</option>
                      </select>
                  </div>
                  <?php } else {?>
                ...
                <div class="form-group">
                  <label for="asalbus" class="col-sm-2 control-label">Asal Bus</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="asalbus" name="asalbus" value="<?php echo $qweq ->asal_bus?>">
                  </div>
                </div>
                <div class="form-group">
                  <label for="tujuanbus" class="col-sm-2 control-label">Tujuan Bus</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="tujuanbus" name="tujuanbus" value="<?php echo $qweq ->tujuan_bus?>">
                  </div>
                </div>
                <?php } ?>
              </div>
