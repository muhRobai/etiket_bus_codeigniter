...
<body class="hold-transition skin-blue sidebar-mini"> 
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        E-BUS
        <small>TAMBAH DATA TIKET</small>
      </h1>
      <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-dashboard"></i> Home</a></li>
        <li class="active">Tambah data tiket</li>
      </ol>
    </section>
      <!--------------------------
        | Your Page Content Here | 
        -------------------------->
        <form class="form-horizontal" method="post" action="<?php echo base_url();?>Admin/update_tiket" role="form">
              <div class="box-body">
                <?php foreach( $tiket as $asda ) { ?>
                <div class="form-group">
                  <label for="kodetiket" class="col-sm-2 control-label">Kode Tiket</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="kodetiket" name="kodetiket" value="<?php echo $asda ->kode_tiket?>">
                  </div>
                </div>
                <!-- -------------------- blm butuh keknya gan!
                <div class="form-group">
                  <label for="namatiket" class="col-sm-2 control-label">Nama Tiket</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="namatiket" name="namatiket" placeholder="MASUKAN NAMA TIKET..">
                  </div>
                </div>
              -->
                <div class="form-group">
                  <label for="stoktiket" class="col-sm-2 control-label">Stok Tiket</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="stoktiket" name="stoktiket" value="<?php echo $asda ->stok?>">
                  </div>
                </div>
                <div class="form-group">
                  <label for="hargatiket" class="col-sm-2 control-label">Harga Tiket</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="hargatiket" name="hargatiket" value="<?php echo $asda ->harga_tiket ?>">
                  </div>
                </div>
                <div class="form-group">
                  <label for="jamberangkat" class="col-sm-2 control-label">Jam Berangkat</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="jamberangkat" name="jamberangkat" value="<?php echo $asda ->jam_berangkat?>">
                  </div>
                </div>
                <div class="form-group">
                  <label for="nomerbus" class="col-sm-2 control-label">Nomer Bus</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="nomerbus" name="nomerbus" value="<?php echo $asda ->nomer_bus ?>" disabled>
                  </div>
                </div>
                <?php } ?>
              </div>
              ...
              <div class="box-footer">
                ...
                <input  type="submit" class="btn btn-warning pull-left-container" name="cancel" value="Kembali"/>
              </div>
              <!-- /.box-footer -->
            </form>
