  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <!--------------------------
        ...
        -------------------------->
        <form class="form-horizontal" method="post" action="<?php echo base_url();?>Admin/add_bus" role="form">
              <div class="box-body">
                <div class="form-group">
                  <label for="kodebus" class="col-sm-2 control-label">Nomor Bus</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="kodebus" name="nobus" value="<?php echo $kode?>" disabled>
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="namabus" placeholder="MASUKAN NAMA bus.." name="namabus">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="asalbus" name="asalbus">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="tujuanbus" name="tujuanbus">
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
