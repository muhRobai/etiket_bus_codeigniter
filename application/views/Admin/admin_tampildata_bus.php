    ...
    <section class="content container-fluid">
      <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Table Bus</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <?php foreach ($bus as $bis) {
                 ?>
                  <td><?php echo $bis ->nomor_bus ?></td>
                  <td><?php echo $bis ->nama_bus ?></td>
                  <td><?php echo $bis ->tipe_bus ?></td>
                  <td><?php echo $bis ->asal_bus ?></td>
                  <td><?php echo $bis ->tujuan_bus ?></td>
                  <td class="ed"><a href="<?php echo base_url()?>Admin/edit_bus/<?php echo $bis->nomor_bus?>" class="btn btn-info"><i class="fa fa-edit"></i></a>
                      <a href="<?php echo base_url()?>Admin/delete_bus/<?php echo $bis ->nomor_bus ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                  </td>
                </tr>
              </tbody>
              <?php } ?>
