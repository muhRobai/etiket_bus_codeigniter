            ...
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                  ...
                  <td><?php echo $key ->nama_promo ?></td>
                  <td><?php echo $key ->ID_promo ?></td>
                  <td><?php echo $key ->awal_promo ?></td>
                  <td> <?php echo $key ->akhir_promo ?></td>
                  <td class="ed"><a href="<?php echo base_url()?>Admin/edit_promo/<?php echo $key ->kode_promo?>" class="btn btn-info"><i class="fa fa-edit"></i></a>
                      <a href="<?php echo base_url()?>Admin/delete_promo/<?php echo $key->kode_promo?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                  </td>
                </tr>
              </tbody>
              <?php } ?>
