  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <!--------------------------
        ...
        -------------------------->
        <form class="form-horizontal" method="post" action="<?php echo base_url();?>Admin/add_tiket" role="form">
              <div class="box-body">
                <div class="form-group">
                  <label for="kodetiket" class="col-sm-2 control-label">Kode Tiket</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="kodetiket" name="kodetiket" disabled value="<?php echo $kode ?>">
                  </div>
                </div>
              ...
              -->
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="stoktiket" name="stoktiket">
                  </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="jamberangkat" name="jamberangkat">
                  </div>
                </div>
                <div class="form-group">
                  ...
                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="nomerbus" name="nomerbus" value="<?php echo $bus?>">
                  </div>
                </div>
              </div>
              <!-- /.box-body -->
