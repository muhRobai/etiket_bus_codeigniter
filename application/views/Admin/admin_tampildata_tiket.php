    ...
    <section class="content container-fluid">
      <div class="box">
            <div class="box-header">
              <h3 class="box-title">Data Table Tiket</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                <tr>
                  <?php foreach ($tiket as $tumbas){?>
                  <td><?php echo $tumbas ->nomer_bus ?></td>
                  <td><?php echo $tumbas ->kode_tiket ?></td>
                  <td><?php echo $tumbas ->stok ?></td>
                  <td><?php echo $tumbas ->harga_tiket ?></td>
                  <td><?php echo $tumbas ->jam_berangkat ?></td>
                  <td class="ed"><a href="<?php echo base_url()?>Admin/edit_tiket/<?php echo $tumbas ->kode_tiket?>" class="btn btn-info"><i class="fa fa-edit"></i></a>
                      <a href="<?php echo base_url()?>Admin/delete_tiket/<?php echo $tumbas ->kode_tiket ?>" class="btn btn-danger"><i class="fa fa-trash"></i></a>
                  </td>
                </tr>
              </tbody>
              <?php } ?>
