  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <!--------------------------
        ...
        -------------------------->
        <form class="form-horizontal" method="post" action="<?php echo base_url();?>Admin/update_promo">
              <div class="box-body">
                <?php foreach ($promo as $sdfs) {?>
                <div class="form-group">
                  <label for="kodepromo" class="col-sm-2 control-label">Kode Promo</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="kodepromo" name="kodepromo" value="<?php echo $sdfs ->kode_promo?>">
                  </div>
                </div>
                <div class="form-group">
                  <label for="namapromo" class="col-sm-2 control-label">Nama Promo</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="namapromo" name="namapromo" value="<?php echo $sdfs ->nama_promo?>">
                  </div>
                </div>
                <div class="form-group">
                  <label for="IDpromo" class="col-sm-2 control-label">ID Promo</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control" id="IDpromo" name="idpromo" value="<?php echo $sdfs ->ID_promo ?>">
                  </div>
                </div>
                <div class="form-group">
                  <label for="waktupromo" class="col-sm-2 control-label">Waktu Promo</label>

                  <div class="col-sm-10">
                    <input type="text" class="form-control"  name="awal" value="<?php echo $sdfs ->awal_promo?>">
                  </div><br><br>
                  <div class="col-sm-2"></div>
                  <div class="col-sm-10">
                    <input type="text" class="form-control"  name="akhir" value="<?php echo $sdfs ->akhir_promo?>">
                  </div>
                </div>
                <div class="box">
            <div class="box-header">
              <h3 class="box-title">Deskripsi Promo
              </h3>
              <!-- tools box -->
            ...
            <div class="box-body pad">
                <textarea class="textarea" placeholder="Place some text here" name="deskripsi" 
                          style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $sdfs ->deskripsi ?></textarea>
            </div>
          </div>
              </div>
              <!-- /.box-body -->
