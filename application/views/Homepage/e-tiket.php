...
<body>
	...
	<section class="verify"> 
		<h3 class="text-center">Pembelian Berhasil</h3>
		<div class="container">
			<div class="row">
				<div col-sm-10>
					<ul class="form-group">
						<li>e-tiket akan dikirim paling lama 3x 24 jam</li>
						<li>e-tiket akan di kirim langsung ke email pemesan</li>
						<li>pembelian e-tiket akan hangus jika anda tidak membayar sampai 6 jam sebelum pemberangkatan</li>
					</ul>
				</div>
			</div>
		</div>
