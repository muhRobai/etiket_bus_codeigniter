	        	...
	        	<div class="just">
	                ...
	                <div class="collapse navbar-collapse" id="menu">
	                	<ul class="nav navbar-nav navbar-left">
	                        ...
	                        <li><a href="<?php echo base_url('Welcome/lihat_tiket')?>">TIKETKU<i class="fa fa-sign-in" aria-hidden="true"></i></a></li>
	                    </ul>
	                    <ul class="nav navbar-nav navbar-right">
	                    	<li><a href="<?php echo base_url('Welcome/keluar')?>">Logout</li>
	                    </ul>
	                </div>
	            </div>
    		</div>
							              ...
							              <div class="box-body">
							                ...
							                <div class="form-group">
							                  <label for="tgl">Tanggal</label>
												<input type="date" name="tgl" class="form-control" role="dd/mm/yy" required>
							                </div>
							            	</div> <div class="col-sm-2"></div>
							            	</div><div class="col-sm-2"></div>
											<div class="col-sm-10">
								                <div class="form-group">
								                  <label for="jumlahpesan">Jumlah pesan</label>
														<select class="form-control" name="jumlahpesan">
															<option>1</option>
									 						<option>2</option>
															<option>3</option>
															<option>4</option>
